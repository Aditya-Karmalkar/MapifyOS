          ...
          <div className="prose max-w-none">
            ...
            <section className="mb-8">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">3.2 Account Security</h3>
                  <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">3.3 Accurate Information</h3>
                  <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            ...
            <section className="mb-8">
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">4.1 API Keys</h3>
                  <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">4.2 Usage Limits</h3>
                  <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">4.3 Prohibited Uses</h3>
            ...
            <section className="mb-8">
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">5.1 Our Rights</h3>
                  <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">5.2 Open Source Components</h3>
                  <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            ...
            {/* Privacy and Data */}
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">6. Privacy and Data</h2>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
            ...
            <section className="mb-8">
              ...
              <div className="bg-gray-50 dark:bg-gray-900 p-4 rounded-lg">
                <p className="text-gray-700 dark:text-gray-300"><strong>Email:</strong> legal@mapifyos.com</p>
