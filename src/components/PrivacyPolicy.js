  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-slate-900">
      <div className="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        {/* Content */}
        <div className="bg-white dark:bg-slate-950 rounded-lg shadow-sm border border-gray-200 dark:border-gray-800 p-8">
          <div className="prose max-w-none">
            ...
            <section className="mb-8">
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">2.1 Personal Information</h3>
                ...
                <div>
                  <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">2.2 Usage Information</h3>
                  <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-2">
                ...
                <div>
                  <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">2.3 Location Information</h3>
                  <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            ...
            <section className="mb-8">
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">4.1 We Do Not Sell Your Data</h3>
                  <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">4.2 Service Providers</h3>
                  <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">4.3 Legal Requirements</h3>
                  <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            ...
            <section className="mb-8">
              ...
              <div className="bg-blue-50 dark:bg-blue-950 p-4 rounded-lg mb-4 border border-blue-200 dark:border-blue-900">
                <h4 className="font-medium text-blue-900 dark:text-blue-300 mb-2">Security Measures Include:</h4>
            ...
            <section className="mb-8">
              ...
              <div className="space-y-3">
                <div>
                  <h4 className="font-medium text-gray-900 dark:text-white">OpenStreetMap</h4>
                  <p className="text-gray-700 dark:text-gray-300 text-sm">
                    We use OpenStreetMap data for our mapping services. Please review their 
                    <a href="https://wiki.osmfoundation.org/wiki/Privacy_Policy" className="text-blue-600 dark:text-blue-400 hover:underline" target="_blank" rel="noopener noreferrer"> Privacy Policy</a>.
                  </p>
                </div>
                <div>
                  <h4 className="font-medium text-gray-900 dark:text-white">Firebase (Google)</h4>
                  <p className="text-gray-700 dark:text-gray-300 text-sm">
                    We use Firebase for authentication and data storage. Please review Google's 
                    <a href="https://policies.google.com/privacy" className="text-blue-600 dark:text-blue-400 hover:underline" target="_blank" rel="noopener noreferrer"> Privacy Policy</a>.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="mb-8">
              ...
              <div className="bg-gray-50 dark:bg-gray-900 p-4 rounded-lg">
                <p className="text-gray-700 dark:text-gray-300"><strong>Email:</strong> privacy@mapifyos.com</p>
                <p className="text-gray-700 dark:text-gray-300"><strong>Website:</strong> https://mapifyos.com</p>
                <p className="text-gray-700 dark:text-gray-300"><strong>Response Time:</strong> We aim to respond within 48 hours</p>
              </div>
            </section>
